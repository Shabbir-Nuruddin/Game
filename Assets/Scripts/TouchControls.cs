...
namespace TrustIssues
{
    ...
    public static class TouchInput
    {
        ...
        public static void Clear() { X = 0f; _jump = false; _fire = false; }
    }

    /// <summary>An on-screen button: hold to move, tap to jump/fire.</summary>
    public class TouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        public int dir; // -1 = left, +1 = right, 0 = jump, 2 = fire
